...
- Inspect Play-generated APKs for package name, version, label, store-icon pixel match, application/round icon linkage, generated size, `allowBackup=false` and no debuggable release manifest.
