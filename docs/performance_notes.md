...
- Signed release AAB: `2,969,759` bytes, about 2.8 MB.
- Debug APK: `20,373,428` bytes, about 19.4 MB.
...
- `play_store` directory total: `7,645` KiB by file bytes, about 7.5 MB.
