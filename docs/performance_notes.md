...
- Signed release AAB: `2,984,214` bytes, about 2.8 MB.
- Debug APK: `19,900,159` bytes, about 19.0 MB.
...
- `play_store` directory total: `8,064` KiB by file bytes, about 7.9 MB.
