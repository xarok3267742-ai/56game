...
| Play account testing path | Internal testing first; closed testing with 12 opted-in testers for 14 continuous days if required by account type, then Play Console production access granted/approved if required | Play Console testing tracks / Dashboard production access request | `play_store/app_content_answers_ru.md`, `play_store/production_access_answers_ru.md`, `play_store/publication_readiness_owner_actions_ru.md` |
