...
2. Inspect Play-generated APKs for package, app name, version, store-icon pixel match, application icon linkage, permissions and native 16 KB page-size posture.
