...
def check_agents_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "with `--apk <path>` it verifies the APK package, version, label, SDK levels, no forbidden permissions, no debug/test leakage and a 512x512 icon candidate.",
            ...
            "populated Play Console support/contact fields for privacy inquiries, public HTTPS privacy-policy URL, secure keystore backup, Play Console forms and required testing tracks.",
        ],
    )
    agents = read("AGENTS.md")
...
def check_readme_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Текущий release AAB: `2,931,068` bytes",
            "`41b2789d25d94a93e1bc2510d296e331fe7e63393b63ea2da0024a2595bdc6dc`",
...
def check_google_play_checklist_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Before entering the URL, run `./tools/check_privacy_policy_url.py --url <https-url>` and require `privacy_policy_url_ok`",
...
def check_release_report_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Публикация в Google Play still requires hosted privacy policy URL, populated Play Console support/contact fields, keystore backup and Play Console forms.",
        ],
    )
...
def check_completion_audit_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "current release AAB is 2,931,068 bytes and current debug APK is 20,050,164 bytes.",
            ...
            "privacy-policy hosting, Play Console support/contact fields, signing backup and Play Console/account actions remain outside the local codebase",
        ],
    )
...
def check_performance_notes() -> None:
    require_text_markers(
        ...
        [
            ...
            "Signed release AAB: `2,931,068` bytes",
...
def check_upload_runbook_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Inspect Play-generated APKs for package, app name, version, icon and permissions.",
...
def check_play_console_packet_helper() -> None:
    ...
    require("./tools/check_privacy_policy_url.py --url <https-url>" in output, "Play Console helper did not print hosted privacy URL check")
...
def check_publication_readiness_helper() -> None:
    ...
    for marker in [
        ...
        "Owner action breakdown",
        "Privacy policy and Play contact: 7 unresolved field(s).",
    ...
    negative_post_upload_cases = [
        ...
        ("First release track used", "production", "never direct production"),
    ...
    completed_post_upload = replace_evidence_lines(
        post_upload_template,
        {
            ...
            "Play Console support/contact field populated": "yes",
            "Support/contact mechanism matches `play_store/privacy_policy_ru.html`": "yes",
            ...
            "Play-generated icon matches `play_store/icon/play_icon_512.png`": "yes",
            ...
            "Content rating completed as Games / Puzzle posture": "yes",
            "Target audience completed as non-child-directed 13+ posture unless publisher intentionally chose a child-directed path": "yes",
            "AI disclosure completed as no in-app generative AI features": "yes",
...
def check_privacy_html() -> None:
    ...
    for marker in [
        ...
        "Policy source text is ready to host and no longer contains a contact-replacement placeholder.",
        "Public HTTPS hosting and populated Play Console support/contact fields remain manual release blockers because they are external to the local codebase.",
...
def check_privacy_safety_handoff() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "Перед публикацией владелец должен заполнить рабочий support contact в Play Console and разместить policy на публичном HTTPS URL.",
