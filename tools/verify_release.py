...
def check_publication_readiness_owner_actions_handoff() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "Evidence must not use bare `yes`; it must explicitly say the Play Console support/contact field is populated with a real support contact for privacy inquiries and that the privacy policy inquiry mechanism uses the Google Play listing support contact.",
            "Signing Backup",
            "play_store/signing_backup_evidence_ru.md",
            "./tools/check_signing_backup_inputs.py",
...
def check_publication_readiness_helper() -> None:
    ...
    completed_post_upload = replace_evidence_lines(
        post_upload_template,
        {
            ...
            "Play Console support/contact field populated": "Play Console support/contact field populated with a real support contact for privacy inquiries",
