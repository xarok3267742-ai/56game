...
def check_agents_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Android Test Platform reports an incomplete instrumentation `Process crashed` marker",
            "Ordinary connected assertion failures still fail.",
            ...
            "`./tools/print_closed_testing_evidence_packet.py` is the read-only owner helper for closed-testing and production-access evidence.",
            "use exactly one of `--not-required` or `--required-completed`",
            "copy only the safe Testing Track Lines",
            ...
            "prints the safe `Store listing preview checked for damaging image crops` line",
...
def check_readme_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Последняя локальная проверка на 14 июня 2026",
            "Google Play sources",
            "product decision",
            "performance notes",
            ...
            "closed-testing handoff - в `play_store/closed_testing_handoff_ru.md`",
            "production-access answer worksheet - в `play_store/production_access_answers_ru.md`",
            "privacy/contact handoff - в `play_store/privacy_contact_handoff_ru.md`",
            ...
            "`./tools/run_api36_connected_gate.py` boots the project-owned `Medium_Phone_API_36` AVD on `emulator-5560` with `-wipe-data`, retries the cleaned AVD once without `-wipe-data` if the emulator exits after the wipe reset before boot",
            "refuses to start a second copy if that AVD is already running on another serial",
            "can pass through `--include-hosted-privacy` for the networked upload-day preflight",
            ...
            "Play-generated APK review note: after the downloaded Play-generated APK is verified, installed and launched",
            ...
            "or returns an incomplete instrumentation `Process crashed` marker",
            "Ordinary connected assertion failures are still returned as failures.",
            "10/10 тестов",
            "pushed release tag",
...
def check_google_play_sources() -> None:
    require_text_markers(
        ...
        [
            ...
            "Latest source spot-check on 14 June 2026",
            ...
            "current release candidate already targets SDK 36",
...
def check_google_play_checklist_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Official source audit: rechecked on 14 June 2026 in `docs/google_play_sources.md`",
            ...
            "Run `./tools/print_store_listing_review_evidence_packet.py` and require `store_listing_review_evidence_packet_ok`",
...
def check_release_plan_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "`play_store/play_console_submission_ru.md`",
            "`play_store/app_content_answers_ru.md`",
            "`play_store/closed_testing_handoff_ru.md` as the closed-testing tester and evidence handoff",
            "`play_store/production_access_answers_ru.md` as the production-access application worksheet",
            "`play_store/privacy_contact_handoff_ru.md` as the privacy URL and support/contact evidence handoff",
            "`play_store/owner_release_inputs.md`",
...
def check_release_report_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Latest closed-testing handoff hardening",
            ...
            "Latest production-access answer worksheet hardening",
            ...
            "Latest Play support/contact inquiry-mechanism evidence hardening",
            "Latest Play support/contact real-contact evidence hardening",
            ...
            "Latest closed-testing evidence packet hardening",
            ...
            "Latest official source spot-check on 14 June 2026",
            "Latest tagged final gate and remote preflight",
            ...
            "Latest duplicate-AVD connected-gate hardening",
            "fails with a clear owner-facing message to stop the existing AVD or rerun with matching `--serial`/`--port`",
            "Latest incomplete-instrumentation retry hardening",
            "Instrumentation run failed due to Process crashed",
            "current connected-gate attempt",
            "Ordinary connected assertion failures still fail",
            "Latest API36 connected evidence refresh after duplicate-AVD hardening",
            "follow-up `./tools/verify_release.py` returned `release_verification_ok`",
            "Latest full managed API36 gate after scoped retry hardening",
            "returned `api36_connected_gate_ok`",
            ...
            "Latest current-tag upload-day preflight for `v1.0.0-rc69`",
            "`./tools/run_upload_day_preflight.py --release-tag v1.0.0-rc69` passed on 12 June 2026",
            "after the final local execution marker gate",
            "included `developer_account_evidence_packet_ok`",
...
def check_completion_audit_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Latest Google Play source spot-check on 14 June 2026",
            "Latest tagged final gate and remote preflight",
            "Latest final local gate after 11 June source audit",
            "Latest annotated remote tag handoff hardening",
            "Latest remote signing-artifact extension hardening",
            ...
            "`./tools/run_upload_day_preflight.py --release-tag v1.0.0-rc69` passed on 12 June 2026",
            "after the final local execution marker gate",
            "hosted final local gate validation with `developer_account_evidence_packet_ok`",
            "Latest Google Play checklist final-gate sequence sync hardening",
            "`tools/verify_release.py` reuses a single `FINAL_LOCAL_GATE_SEQUENCE` assertion for both the checklist and `play_store/upload_runbook_ru.md`",
            "Latest release-plan final-gate sequence sync hardening",
            "`tools/verify_release.py` now checks it through the shared `FINAL_LOCAL_GATE_SEQUENCE` assertion too",
...
def check_qa_test_plan_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Latest duplicate-AVD and incomplete-instrumentation retry QA",
            "fails before startup with a clear owner-facing message",
...
def check_asset_handoff() -> None:
    ...
    require(
        "Closed testing handoff: `play_store/closed_testing_handoff_ru.md`" in upload_manifest,
        "upload manifest must include closed testing handoff",
    )
    require(
        "Production access answers: `play_store/production_access_answers_ru.md`" in upload_manifest,
        "upload manifest must include production access answer worksheet handoff",
    )
    require(
        "Privacy/contact handoff: `play_store/privacy_contact_handoff_ru.md`" in upload_manifest,
        "upload manifest must include privacy/contact handoff",
    )
    require(
    ...
    require(
        "Play Console forms evidence packet helper: `tools/print_play_console_forms_evidence_packet.py`" in upload_manifest,
...
def check_upload_runbook_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "Use `play_store/closed_testing_handoff_ru.md` for tester instructions, aggregate feedback topics and safe evidence wording.",
            "Closed-testing handoff: `play_store/closed_testing_handoff_ru.md`.",
            "Production-access answer worksheet: `play_store/production_access_answers_ru.md`.",
...
def check_final_local_gate_runner() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "STALE_CONNECTED_QUIET_SECONDS",
            "STALE_CONNECTED_SETTLE_TIMEOUT_SECONDS",
            "STALE_CONNECTED_POLL_SECONDS",
            ...
            "def uninstall_stale_connected_packages(",
            "def wait_for_stale_connected_packages_to_settle(",
            "Stale connected packages kept reappearing",
            "Stale connected package quiet window timed out",
            "def clear_connected_logcat(",
            ...
            "$ clear selected-device logcat after stale connected package cleanup",
            "- wait for stale connected packages to stay absent and clear selected-device logcat",
            "ANDROID_SERIAL",
...
def check_api36_connected_gate_helper() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "connected_instrumentation_process_crashed(",
            "gate_started_at = time.time()",
            "path.stat().st_mtime < since",
            "running_matching_avds(",
            "already running on {running}; stop that emulator first or rerun with matching --serial/--port",
            "wipe-data boot exited before boot; retrying cleaned AVD without -wipe-data",
            "connected final gate lost API 36 emulator or hit incomplete instrumentation process crash; retrying once with freshly booted AVD without -wipe-data",
    ...
    for marker in [
        ...
        "- refuse to start a second copy if the requested AVD is already running on another serial",
        ...
        "- if the managed run reports an incomplete instrumentation process crash, restart the cleaned AVD once without -wipe-data and rerun that gate",
...
def check_closed_testing_evidence_packet_helper() -> None:
    helper = require_file("tools/print_closed_testing_evidence_packet.py")
    require(os.access(helper, os.X_OK), "tools/print_closed_testing_evidence_packet.py must be executable")
    require_text_markers(
        "tools/print_closed_testing_evidence_packet.py",
        [
            ...
            "DESTINATION_EVIDENCE = \"play_store/play_console_post_upload_evidence_ru.md\"",
            "def validate_no_forbidden_evidence(",
            "must not contain tester email addresses",
            "must not contain tester URLs or private links",
            "def evidence_lines(",
            "Closed testing required for this account",
            "Closed testing status if required",
            "Production access status if required",
            "completed required closed testing with 12 opted-in testers for 14 continuous days",
            "Play Console production access granted",
            "--not-required",
            "--required-completed",
            "closed_testing_evidence_packet_dry_run_ok",
            "closed_testing_evidence_packet_ok",
        ],
    )
    ...
    for marker in [
        "Closed testing evidence packet",
        "Destination evidence file: play_store/play_console_post_upload_evidence_ru.md",
        "Use one evidence mode only after the matching Play Console account path is actually confirmed.",
        "Do not record tester names, tester emails, invite links, private URLs, screenshots with account data or tokens.",
        "Available Evidence Modes",
        "./tools/print_closed_testing_evidence_packet.py --not-required",
        "./tools/print_closed_testing_evidence_packet.py --required-completed",
        "closed_testing_evidence_packet_dry_run_ok",
    ]:
        require(marker in dry_run_output, f"closed-testing evidence packet dry run missing marker: {marker}")

    not_required_output = subprocess.check_output(
        [str(helper), "--not-required"],
        cwd=ROOT,
        stderr=subprocess.STDOUT,
        text=True,
    )
    for marker in [
        ...
        require(marker in not_required_output, f"closed-testing not-required output missing marker: {marker}")

    required_output = subprocess.check_output(
        [str(helper), "--required-completed"],
        cwd=ROOT,
        stderr=subprocess.STDOUT,
        text=True,
    )
    for marker in [
        ...
        require(marker in required_output, f"closed-testing required-completed output missing marker: {marker}")

    spec = importlib.util.spec_from_file_location("line56_closed_testing_evidence_packet", helper)
    require(spec is not None and spec.loader is not None, "closed-testing evidence packet helper could not be loaded")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    not_required_lines = "\n".join(module.evidence_lines(module.MODE_NOT_REQUIRED))
    required_lines = "\n".join(module.evidence_lines(module.MODE_REQUIRED_COMPLETED))
    for marker in ["Closed testing required for this account: no", "not required for this account"]:
        require(marker in not_required_lines, f"closed-testing not-required lines missing marker: {marker}")
    for marker in ["Closed testing required for this account: yes", "12 opted-in testers", "14 continuous days", "Play Console production access granted"]:
        require(marker in required_lines, f"closed-testing required-completed lines missing marker: {marker}")
    for bad_value, expected_message in [
        ("tester@example.com", "tester email addresses"),
        ("https://private.example/testers", "tester URLs or private links"),
        ("token=secret", "password, token, secret or API key assignments"),
        ("storePassword=secret", "forbidden marker"),
    ]:
        try:
            module.validate_no_forbidden_evidence(bad_value)
        except module.ClosedTestingEvidencePacketError as exc:
            require(expected_message in str(exc), f"closed-testing helper rejected bad evidence with unexpected message: {exc}")
        else:
            raise CheckFailure(f"closed-testing helper must reject bad evidence: {bad_value}")
...
def check_play_console_forms_evidence_packet_helper() -> None:
    helper = require_file("tools/print_play_console_forms_evidence_packet.py")
    require(os.access(helper, os.X_OK), "tools/print_play_console_forms_evidence_packet.py must be executable")
    require_text_markers(
        "tools/print_play_console_forms_evidence_packet.py",
        [
            ...
            "It does not claim that Play Console",
            "FORBIDDEN_EVIDENCE_MARKERS",
            "class PlayConsoleFormsEvidencePacketError",
            "def validate_no_forbidden_evidence(",
            "must not contain personal email addresses",
            "must not contain private URLs or invite links",
            "def evidence_lines(",
            ...
            "Destination evidence file: play_store/play_console_post_upload_evidence_ru.md",
            "Use these lines only after the matching Play Console forms are actually completed.",
            "play_console_forms_evidence_packet_ok",
        ],
    )
    output = subprocess.check_output(
    ...
    for marker in [
        ...
        "Destination evidence file: play_store/play_console_post_upload_evidence_ru.md",
        "Use these lines only after the matching Play Console forms are actually completed.",
        "Do not record account tokens, support-contact values, tester personal data or invite links.",
        ...
        require(marker in output, f"Play Console forms evidence packet missing marker: {marker}")

    spec = importlib.util.spec_from_file_location("line56_play_console_forms_evidence_packet", helper)
    require(spec is not None and spec.loader is not None, "Play Console forms evidence packet helper could not be loaded")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    lines = module.evidence_lines()
    joined = "\n".join(lines)
    for marker in [
        "no restricted access, no login and no account",
        "no ads",
        "no user data collected and no user data shared",
        "Games / Puzzle",
        "13+ non-child-directed",
        "no in-app generative AI features",
    ]:
        require(marker in joined, f"Play Console forms evidence packet generated lines missing marker: {marker}")
    for bad_value, expected_message in [
        ("support@example.com", "personal email addresses"),
        ("https://private.example/invite", "private URLs or invite links"),
        ("token=secret", "password, token, secret or API key assignments"),
        ("storePassword=secret", "forbidden marker"),
    ]:
        try:
            module.validate_no_forbidden_evidence(bad_value)
        except module.PlayConsoleFormsEvidencePacketError as exc:
...
def check_store_listing_review_evidence_packet_helper() -> None:
    helper = require_file("tools/print_store_listing_review_evidence_packet.py")
    require(os.access(helper, os.X_OK), "tools/print_store_listing_review_evidence_packet.py must be executable")
    require_text_markers(
        "tools/print_store_listing_review_evidence_packet.py",
        [
            ...
            "def png_size(",
            "def verify_review_sheet(",
            "def validate_no_forbidden_evidence(",
            "must not contain personal email addresses",
            "must not contain private URLs or account links",
            "def evidence_lines(",
            "Store listing preview checked for damaging image crops",
            "feature graphic, phone screenshots and tablet screenshots",
            "no damaging crops",
            "store_listing_review_evidence_packet_ok",
        ],
    )
    ...
    for marker in [
        "Store listing review evidence packet",
        "Destination evidence file: play_store/play_console_post_upload_evidence_ru.md",
        "Source review sheet: play_store/store_asset_review_sheet.png",
        "Source review command: ./tools/create_store_asset_review_sheet.py --write",
        "Use these lines only after the Play Console store listing preview and current store asset review sheet are actually checked.",
        "Do not record account tokens, screenshots with account data, private URLs or reviewer personal data.",
        "Store Preview Lines",
        "Store listing preview checked for damaging image crops: Play Console store listing preview and current store asset review sheet checked for icon, feature graphic, phone screenshots and tablet screenshots; no damaging crops.",
        "store_listing_review_evidence_packet_ok",
    ]:
        require(marker in output, f"store-listing review evidence packet missing marker: {marker}")

    spec = importlib.util.spec_from_file_location("line56_store_listing_review_evidence_packet", helper)
    require(spec is not None and spec.loader is not None, "store-listing review evidence packet helper could not be loaded")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    lines = module.evidence_lines()
    joined = "\n".join(lines)
    for marker in ["icon", "feature graphic", "phone screenshots", "tablet screenshots", "no damaging crops"]:
        require(marker in joined, f"store-listing review helper generated line missing marker: {marker}")
    require(
        module.png_size(ROOT / "play_store/store_asset_review_sheet.png") == (1800, 2050),
        "store-listing review helper must read the current review sheet dimensions",
    )
    for bad_value, expected_message in [
        ("reviewer@example.com", "personal email addresses"),
        ("https://private.example/preview", "private URLs or account links"),
        ("token=secret", "password, token, secret or API key assignments"),
        ("storePassword=secret", "forbidden marker"),
    ]:
        try:
            module.validate_no_forbidden_evidence(bad_value)
        except module.StoreListingReviewEvidencePacketError as exc:
            require(expected_message in str(exc), f"store-listing review helper rejected bad evidence with unexpected message: {exc}")
        else:
            raise CheckFailure(f"store-listing review helper must reject bad evidence: {bad_value}")
...
def check_play_upload_archive_helper() -> None:
    ...
    for marker in [
        ...
        "line56_v1_google_play_upload_packet/_owner_handoff/closed_testing_handoff_ru.md",
        "line56_v1_google_play_upload_packet/_owner_handoff/production_access_answers_ru.md",
        "line56_v1_google_play_upload_packet/_owner_handoff/privacy_contact_handoff_ru.md",
...
def check_play_console_packet_helper() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "Prepare production-access answers with play_store/production_access_answers_ru.md if Play Console asks for them.",
            "play_console_packet_ok",
        ],
    )
    output = subprocess.check_output(
    ...
    require(
        "Use play_store/privacy_contact_handoff_ru.md for privacy/contact safe evidence wording." in output,
        "Play Console helper did not print privacy/contact handoff gate",
    )
    require(
        "Use play_store/closed_testing_handoff_ru.md for closed-test tester instructions and safe evidence phrases." in output,
        "Play Console helper did not print closed-testing handoff gate",
    )
    ...
    require(
        "Prepare production-access answers with play_store/production_access_answers_ru.md if Play Console asks for them." in output,
        "Play Console helper did not print production-access worksheet gate",
    )
...
def check_publication_readiness_helper() -> None:
    ...
    require_text_markers(
        ...
        [
            ...
            "must explicitly say the Play Console support/contact field uses a real support contact for privacy inquiries",
            ...
            "must explicitly say Play policy warnings have no warnings, no unresolved warnings or were resolved",
    ...
    for marker in [
        ...
        "command: ./tools/print_closed_testing_evidence_packet.py --not-required",
    ...
    negative_post_upload_cases = [
        ...
        ("Pre-launch report result", "Play Console pre-launch report reviewed", "passed or has no blocking issues"),
        ("Reproducible crashes in pre-launch report", "none", "missing"),
        ("Reproducible crashes in pre-launch report", "pre-launch report has no crashes", "no reproducible crashes"),
        ("Play policy warnings", "none", "missing"),
        ...
        ("Play Console support/contact field populated", "Play Console support/contact field populated", "missing"),
        (
            "Play Console support/contact field populated",
            "Play Console support/contact field populated with a real support contact",
            "privacy inquiries",
        ),
        (
            "Play Console support/contact field populated",
            "Play Console support/contact field populated with a real support contact for privacy inquiries",
            "support email or support website",
        ),
        (
            "Play Console support/contact field populated",
            "Play Console support/contact field populated with a real support contact email for privacy inquiries: support@example.com",
            "actual support email",
        ),
        (
            "Play Console support/contact field populated",
            "Play Console support/contact field populated with a real support contact support website URL for privacy inquiries: https://support.example.com",
            "actual support website URL",
        ),
        (
        ...
        (
            "Support/contact mechanism matches `play_store/privacy_policy_ru.html`",
            "privacy policy uses the Google Play listing support contact",
            "missing",
        ),
    ...
    completed_signing_backup = replace_evidence_lines(
        read("play_store/signing_backup_evidence_ru.md"),
        {
            ...
            "Backup record location in owner tracker or password manager": "owner password manager backup record",
        },
    )
    ...
    negative_signing_evidence_cases = [
        ...
        ("Backup completed before Play upload", "yes", "missing"),
        (
            "Backup completed before Play upload",
            "private/signing/qgrid-upload.p12 backed up before Play upload",
            "missing",
        ),
        (
            "Backup completed before Play upload",
        ...
        ("Responsible owner", "release owner", "missing"),
        ("Responsible owner", "owner tracker", "missing"),
        ("Backup record location in owner tracker or password manager", "owner password manager release record", "missing"),
        ("Backup record location in owner tracker or password manager", "backup record in storage", "owner tracker or password manager"),
...
def check_closed_testing_handoff() -> None:
    require_text_markers(
        "play_store/closed_testing_handoff_ru.md",
        [
            ...
            "https://support.google.com/googleplay/android-developer/answer/14151465?hl=en",
            "production access требует closed test with at least 12 testers who have been opted-in for at least the last 14 days continuously",
            "internal testing",
            "clear instructions",
            ...
            "offline-first, no `INTERNET`, no `ACCESS_NETWORK_STATE`, no user data collected or shared",
            "Owner Closed-Test Setup",
            "./tools/run_final_local_gate.py --include-hosted-privacy",
            "final_local_gate_ok",
            "Upload the signed AAB to internal testing first.",
            "./tools/verify_play_generated_apk.py --apk <path-to-play-generated.apk>",
            "Manage tester access outside this repository.",
            "private Play Console opt-in link, Google Group, tester email list or support channel must not be committed.",
            ...
            "Production access status if required: not required for this account.",
            "Stop Conditions",
            "fewer than 12 testers are opted in",
    ...
    text = read("play_store/closed_testing_handoff_ru.md")
    for forbidden in [
        "tester@example.com",
        "BEGIN PRIVATE KEY",
        "storePassword=",
        ...
        require(forbidden not in text, f"closed testing handoff must not include forbidden marker: {forbidden}")


def check_privacy_contact_handoff() -> None:
    require_text_markers(
        "play_store/privacy_contact_handoff_ru.md",
        [
            ...
            "privacy point of contact or a mechanism to submit inquiries",
            "active, publicly accessible and non-geofenced URL, no PDFs, and non-editable",
            "не должен содержать реальный support email, support website URL, Play account tokens, screenshots with account data, passwords, keystore contents or private keys",
            "App name: `Линия 56`.",
            "Package: `com.qgrid.mobile`.",
            ...
            "no user data collected, no user data shared, no ads, no analytics, no accounts, no payments, no `INTERNET`, no `ACCESS_NETWORK_STATE`, Android backup disabled",
            "Choose a real support contact outside this repository.",
            ...
            "Privacy policy URL is not PDF: yes.",
            "Stop Conditions",
            "support/contact field is empty or uses a disposable/unmonitored contact",
            "recorded evidence contains the actual support email address or support website URL",
    ...
    text = read("play_store/privacy_contact_handoff_ru.md")
    for forbidden in [
        "support@example.com",
        ...
        require(forbidden not in text, f"privacy/contact handoff must not include forbidden marker: {forbidden}")


def check_production_access_answers_handoff() -> None:
    require_text_markers(
        "play_store/production_access_answers_ru.md",
        [
            ...
            "Не записывать сюда персональные данные тестеров",
            "email addresses",
            "invite links",
            "private tester URLs",
            "Play account tokens",
            "screenshots with account data",
            "passwords, keystore contents or private keys",
            "App name: `Линия 56`.",
            "Package: `com.qgrid.mobile`.",
            ...
            "at least 12 opted-in testers for at least 14 continuous days",
            "No tester names, email addresses or invite links are included here.",
            "About Your App Or Game",
            "intended audience is general puzzle players age 13+",
            "not child-directed",
            "Линия 56 is focused on one clear rule",
            ...
            "./tools/print_publication_readiness.py --check-recorded-privacy-url --require-production-ready",
            "Production access status if required.",
            "The production-access application is not complete until Play Console production access is granted or approved",
        ],
    )
    text = read("play_store/production_access_answers_ru.md")
    for forbidden in [
        "tester@example.com",
        "BEGIN PRIVATE KEY",
        "storePassword=",
        ...
        require(forbidden not in text, f"production access answers must not include forbidden marker: {forbidden}")
...
def check_post_upload_evidence_handoff() -> None:
    require_text_markers(
        ...
        [
            ...
            "that it is populated with a real support contact for privacy inquiries",
...
def check_privacy_html() -> None:
    ...
    for marker in [
        ...
        "Confirm `play_store/privacy_contact_handoff_ru.md` safe evidence phrases are used in `play_store/play_console_post_upload_evidence_ru.md` without recording the actual support email or URL.",
...
def run_checks() -> None:
    checks = [
        ...
        check_privacy_contact_handoff,
        check_production_access_answers_handoff,
